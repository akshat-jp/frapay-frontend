...
export function Dashboard(){
        ...
        const navigate = useNavigate();
            ...
            axios.get("https://frapay-backend.vercel.app/api/v1/user/me",{
                headers:{
                    Authorization : token,
                }
            })
        ...
        useEffect(()=>{
            const token = localStorage.getItem("token")
            axios.get("https://frapay-backend.vercel.app/api/v1/accounts/balance",{
                headers:{
                    Authorization : token,
                }
            })
        ...
        useEffect(()=>{
            axios.get("https://frapay-backend.vercel.app/api/v1/user/bulk?filter=" + filter,{
                headers:{
